...
/**
 * This class should be the interceptor for REST service access to the BoardGameGeek game
 * information.
 * <p>
...
public class BGGDataController {
  ...
  /**
   * GET method designed to handle retrieving the raw BoardGameGeek content from the
  ...
  public Object getRawBGGGame(@RequestParam(value="bggid") long bggID, @RequestParam(value="source", defaultValue="bgg") String source) {
